...
class AppConfig {
  static const _androidEmulatorBaseUrl = "https://api.kobrealestate.com.ng";
  static const _iosSimulatorBaseUrl = "https://api.kobrealestate.com.ng";

  // Update this for physical devices on your LAN.
  static const _deviceBaseUrl = "https://api.kobrealestate.com.ng";
